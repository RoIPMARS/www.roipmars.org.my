...
<html lang='ms-MY' data-bs-theme='auto'>
  ...
  <head>
    <title>Sijil NCS Mingguan RoIP MARS</title>
  </head>

  <body>
    <?php include __DIR__.'/../../ntsheader.php' ?>
    <div class='container my-2'>
      <h1 class='text-center'>Notice NCS Certificate</h1>
      <table class='table table-sm table-borderless fs-5 text-center d-flex justify-content-end'>
        <tbody>
          <tr><td>Rujukan Notis</td><td>NtsMARS2020/02</td></tr>
          <tr><td>Tarikh Notis</td><td>08 Feb 2020, 2100 MYT</td></tr>
        </tbody>
      </table>
