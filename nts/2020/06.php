...
<html lang='ms-MY' data-bs-theme='auto'>
  ...
  <body>
    ...
    <div class='container my-2'>
      <h1 class='text-center'>Notice Website interruption for service upgrade</h1>
      <table class='table table-sm table-borderless fs-5 text-center d-flex justify-content-end'>
        <tbody>
          <tr><td>Rujukan Notis</td><td>NtsMARS2020/06</td></tr>
          <tr><td>Tarikh Notis</td><td>23 Mac 2020, 0100 MYT</td></tr>
        </tbody>
      </table>
