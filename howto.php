      ...
      <div class='row'>
        <div class='col-md mb-2 text-center'>
          ...
          <div class='btn-group d-flex mx-auto mb-1' role='group'>
            <a class='btn' style='color: #024eff;; border-color: #0071ff' type='button' href='https://github.com/roipmars/rustdesk/releases/latest/download/rustdesk-1.3.1-x86_64.msi' target='_blank' rel='external' download>RustDesk &lpar;Windows&rpar; <i class='bi-windows'></i></a>
            <a class='btn' style='color: #024eff;; border-color: #0071ff' type='button' href='https://github.com/roipmars/rustdesk/releases/latest/download/rustdesk-1.3.1-x86_64.dmg' target='_blank' rel='external' download>RustDesk &lpar;Mac&rpar; <i class='bi-apple'></i></a>
            <a class='btn' style='color: #024eff;; border-color: #0071ff' type='button' href='https://github.com/roipmars/rustdesk/releases/latest/download/rustdesk-1.3.1-x86_64.deb' target='_blank' rel='external' download>RustDesk &lpar;Linux&rpar; <i class='bi-ubuntu'></i></a>
          </div>
