  ...
  <div class='container'>
    ...
    <div class='row'>
      <div class='col-md mb-2 text-center'>
        ...
        <p class='mb-1'>Perisian tambahan untuk bantuan:</p>
        <div class='btn-group d-flex mx-auto mb-1' role='group'>
          <a class='btn' style='color: #024eff;; border-color: #0071ff' type='button' href='https://github.com/roipmars/rustdesk/releases/download/1.3.8/rustdesk-1.3.8-x86_64.msi' target='_blank' rel='external' download>RustDesk &lpar;Windows&rpar; <i class='bi-windows'></i></a>
          <a class='btn' style='color: #024eff;; border-color: #0071ff' type='button' href='https://github.com/roipmars/rustdesk/releases/download/1.3.8/rustdesk-1.3.8-x86_64.dmg' target='_blank' rel='external' download>RustDesk &lpar;Mac&rpar; <i class='bi-apple'></i></a>
          <a class='btn' style='color: #024eff;; border-color: #0071ff' type='button' href='https://github.com/roipmars/rustdesk/releases/download/1.3.8/rustdesk-1.3.8-x86_64.deb' target='_blank' rel='external' download>RustDesk &lpar;Linux&rpar; <i class='bi-ubuntu'></i></a>
        </div>
        <!-- <div class='btn-group d-flex mx-auto mt-1' role='group'>
          ...
          <a class='btn' style='color: #fb4137; border-color: #fb4137' type='button' href='https://download.anydesk.com/anydesk.dmg' target='_blank' rel='external' download>AnyDesk &lpar;Mac&rpar; <i class='bi-apple'></i></a>
          <a class='btn' style='color: #fb4137; border-color: #fb4137' type='button' href='https://download.anydesk.com/linux/anydesk_6.3.2-1_amd64.deb' target='_blank' rel='external' download>AnyDesk &lpar;Linux&rpar; <i class='bi-ubuntu'></i></a>
        </div> -->
      </div>
    </div>
        ...
        <table class='table table-sm text-center align-middle'>
          <tbody>
            ...
            <tr>
              ...
              <td><a class='btn btn-primary' role='button' href='https://dl.roipmars.org.my/files/downloads/android/teamspeak/roipmars-ts-3.0.3.1.apk' target='_blank' download>Versi Tiada Sokongan Google<br>&lpar;kurang ciri khas&rpar;</a></td>
            </tr>
            <!-- <tr>
    ...
    <div id='androidcr' class='row no-gutters bg-light-subtle position-relative mb-3 rounded-5'>
      ...
      <div class='col-lg-5 position-static p-3'>
        <h5 class='mt-0 text-center'>Pasang &amp; Konfigurasikan Teamspeak dalam Android<br><em>&lpar;TIADA SOKONGAN-AKHIR DIS 2020&rpar;</em></h5>
        ...
        <table class='table table-sm text-center align-middle'>
          <tbody>
            ...
            <tr>
              ...
              <td><a class='btn btn-sm btn-primary' role='button' href='https://dl.roipmars.org.my/files/downloads/android/teamspeak/roipmars-ts-3.0.3.1.apk' target='_blank' download>Muat Turun</a></td>
            </tr>
          </tbody>
        </table>
      </div>
